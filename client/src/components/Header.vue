<template>
  ...
  <!--
    ...
    Plugins:
      - @tailwindcss/forms
  -->
  <section class="bg-gray-50 dark:bg-gray-900 bg-cover bg-center" style="background-image: url('https://lh3.googleusercontent.com/p/AF1QipM_A40B0P5CPf2jp8ZwpEb-Kk6rxmAMysXU9Zlz=s680-w680-h510'); height: 87vh;">
