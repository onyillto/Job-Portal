...
<div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          >
            ...
            <div class="border-t border-blue-gray-50 p-4">
              ...
              >
                <strong class="text-green-500">+20%</strong>&nbsp;than last year
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="border-t border-blue-gray-50 p-4">
              <p
                class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
              >
                <strong class="text-green-500">+3%</strong>&nbsp;than last year
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="border-t border-blue-gray-50 p-4">
              <p
                class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
              >
                <strong class="text-red-500">-2%</strong>&nbsp;than last Year
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="border-t border-blue-gray-50 p-4">
              <p
                class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
              >
                <strong class="text-green-500">+5%</strong>&nbsp;than last Year
              </p>
            </div>
          </div>
        </div>
